...
FIXTURE_NONEMPTY_DIR = os.path.join(
    os.path.dirname(os.path.realpath(__file__)), "test_files", "nonempty_dir"
)

FIXTURE_HIDDEN_DIR = os.path.join(
    os.path.dirname(os.path.realpath(__file__)), "test_files", ".hidden_dir"
)
...
def empty_dir():
    ...
    return os.path.join(UPLOAD_PATH_TEST, "empty_dir")
...
def hidden_dir():
    ...
    return os.path.join(UPLOAD_PATH_TEST, ".hidden_dir")
...
def empty_file():
    ...
    return os.path.join(UPLOAD_PATH_TEST, "empty.txt")
...
def empty_file_json():
    ...
    return os.path.join(UPLOAD_PATH_TEST, "empty.json")
...
def not_allowed_file():
    ...
    return os.path.join(FIXTURE_NONEMPTY_DIR, "not_allowed.jpg")
...
def hidden_file():
    ...
    return os.path.join(FIXTURE_HIDDEN_DIR, ".hidden.txt")
